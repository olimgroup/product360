(function(){
  ...
  ArcSlider.prototype._addEvent = function () {
    ...
    this.slider.addEventListener('mousedown touchstart', this._mousedown);
    this.slider.addEventListener('mousecancel touchcancel', this._mouseup);
    this.slider.addEventListener('mousemove touchmove', this._mousemove);
