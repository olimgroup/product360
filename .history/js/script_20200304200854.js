...
ArcSlider.prototype.initEvent = function () {
  this.slider
}

ArcSlider.prototype.mousedown = function (x) {
  this.isMouseDown = true;
  this.mouseX = x;
}

ArcSlider.prototype.mouseup = function () {
  this.isMouseDown = false;
}

ArcSlider.prototype.mousemove = function (x) {
  if (this.prevPos !== x) {
    if (this.isMouseDown) {
      if (x < this.prevPos) {
        this.count--;
