(function(){
  ...
  ArcSlider.prototype._addEvent = function () {
    this.prototype._mousedown = this.__mousedown.bind(this);
    this.prototype._mouseup = this.__mouseup.bind(this);
    this.prototype._mousemove = this.__mousemove.bind(this);
