(function(){
  ...
  ArcSlider.prototype._addEvent = function () {
    ...
    this.slider.addEventListener('touchstart', this._mousedown, false);
    this.slider.addEventListener('touchcancel', this._mouseup, false);
    this.slider.addEventListener('touchmove', this._mousemove, false);
  }
